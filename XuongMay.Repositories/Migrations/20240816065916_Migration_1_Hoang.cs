...
{
    /// <inheritdoc />
    public partial class Migration_1_Hoang : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NumberOfStaffs = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK__Order_Status", "[Status] = 'Done' OR [Status] = 'In Progress' OR [Status] = 'Created'");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Task", x => new { x.OrderId, x.AssemblyLineId });
                    table.CheckConstraint("CK__Task_Status", "[Status] = 'Done' OR [Status] = 'In Progress' OR [Status] = 'Created'");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AssemblyLines_ManagerId",
                table: "AssemblyLines",
                column: "ManagerId",
                unique: true);
